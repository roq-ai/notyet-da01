...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Invoices', path: '/invoices', entity: 'invoice', service: AccessServiceEnum.PROJECT, icon: FiBox },
    {
      name: 'Permissions',
      path: '/permissions',
      entity: 'permission',
    ...
    { name: 'Roles', path: '/roles', entity: 'role', service: AccessServiceEnum.PROJECT, icon: FiBox },
