...
import { getAccountingById } from 'apiSdk/accountings';
...
function AccountingViewPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<AccountingInterface>(
    () => (id ? `/accountings/${id}` : null),
    () =>
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('accounting', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/accountings/edit/${id}`} passHref legacyBehavior>
                    <Button
