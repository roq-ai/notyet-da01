...
export function CompanyListPage(props: CompanyListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getCompanies({
        relations: ['user', 'accounting.count', 'invoice.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('accounting', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'accounting',
          header: 'Accounting',
          accessorKey: 'accounting',
          cell: ({ row: { original: record } }: any) => record?._count?.accounting,
        }
      : null,
