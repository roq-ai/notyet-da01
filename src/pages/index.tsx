  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to NotYet - Streamlining Your Business with Advanced Invoice Processing and Automatic Accounting Solutions. Let's Make Accounting Effortless!"
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to NotYet - Streamlining Your Business with Advanced Invoice Processing and Automatic Accounting Solutions. Let's Make Accounting Effortless!`}
            </Text>
            <Box
