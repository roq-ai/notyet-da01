...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'invoice.create': {
    roles: ['owner', 'finance-manager', 'administrator'],
    key: 'invoice-uploaded',
    tenantPath: ['company', 'invoice'],
    userPath: [],
  },
  'invoice.delete': {
    roles: ['owner', 'accountant', 'finance-manager'],
    key: 'invoice-deleted',
    tenantPath: ['company', 'invoice'],
    userPath: [],
  },
